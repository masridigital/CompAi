...
describe('Admin controllers security baseline', () => {
  ...
  it('covers all 10 expected org-scoped admin controllers', () => {
    expect(ORG_ADMIN_CONTROLLERS).toHaveLength(10);
  });
  ...
  it('covers all 12 admin controllers (10 org-scoped + 2 platform-scoped)', () => {
    expect(ORG_ADMIN_CONTROLLERS).toHaveLength(10);
